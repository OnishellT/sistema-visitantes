            ...
            <div class="modal-header">
                <div class="media flex-fill">
                    ...
                    <div class="media-body align-self-center">
                        <h5 class="modal-title">Invitar Visitantes</h5>
                        <p class="small">Invitar Colegas,Empleados y Amigos.</p>
                    </div>
                </div>
            ...
            <div class="modal-body">
                <form action="#">
                    ...
                    <div class="form-group mb-0">
                        <label for="invite-message" class="small">Mensaje de Invitacion</label>
