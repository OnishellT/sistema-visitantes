        ...
        <div class="container">
            <div class="card"  style="margin-top:40px;">
                <div class="card-header" id="Details" align="center">
                    <h4 style="color: #111570;font-weight: bold">{{__('Revision de informacion')}}</h4>
                </div>
                            ...
                            <div class="img-cards" id="printidcard">
                                <div class="id-card-holder">
                                    <div class="id-card">
                                        ...
                                        <h1>{{$visitingDetails['first_name']}}{{' '}}{{$visitingDetails['last_name']}}</h1>
                                        <h2>{{__('Numero Telefonico: ')}}{{$visitingDetails['phone']}}</h2>
                                        <!--<h2>{{$visitingDetails['email']}}</h2>-->
                                        <!--<h2>{{$visitingDetails['address']}}</h2>-->
                                        <h2>{{$visitingDetails['company_name']}}</h2>
                                        <h2>{{__('Visita')}}</h2>
                                        @if($employee)
                                        <h3>{{__('Empleado:')}} {{$employee->name}}</h3>
                                        @endif
                                        <hr>
                                        <!--<p><strong>{{ setting('site_name') }} </strong></p>-->
                                        <p><strong>{{ setting('site_address') }} </strong></p>
                                        <p>{{__('Telefono:')}}{{ setting('site_phone') }} | E-mail: {{ setting('site_email') }} </p>
                                    </div>
                                </div>
                            </div>
                        </div>
