    ...
    <div class="container">
                <div class="row">
                    ...
                    <div class="card"  style="margin-top:40px;">
                        <div class="card-header" id="Details" align="center"><h4 style="color: #111570;font-weight: bold">Detalles del visitantes</h4></div>
                        <div class="card-header" id="Visitorimg" align="center"><h4 style="color: #111570;font-weight: bold">Foto</h4></div>
                        <div class="card-header" id="VisitorAgreement" align="center"><h4 style="color: #111570;font-weight: bold">Acuerdo</h4></div>
                        <div style="margin: 10px;">
                         ...
                         <div class="save">
                                                ...
                                                <div class="col-md-3 col-sm-12">
                                                    <div>
                                                        <button type="button" id="continue2" class='arrows btn btn-primary '>
                                                            <img class="img" src="{{ asset('website/img/arrow9.jpg')}}"> <span>Continuar</span>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div style="margin-top: 50px">
                                        <div class="row">
                                            <div class="col-md-6" align="center">
                                                <h3 style="color: #111570;font-weight: bold">Nombre</h3>
                                                <p id="VisitorAgreementtag">{{$visitor->first_name}} {{$visitor->last_name}}</p>
                                            </div>
                                            <div class="col-md-6" align="center">
                                                <h3 style="color: #111570;font-weight: bold">Fecha</h3>
                                                <p>{{date('d-m-Y')}}</p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div style="margin: auto;width: 400px;">
                                            ...
                                            <div style="float: right;">
                                                <div style="margin: 8px">
                                                    <input type="checkbox" id="myCheck" name="emailCheck"  onclick="myFunction()"> <span style="color: #111570;">Correo del Visitante</span>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                {!! Form::close() !!}
                                    @else
                                    <div>
                                        <h4 align="center" style="color: #ff6666">ID no Disponible</h4>
                                    </div>
                                    @endif
                                </div>
                            </div>
