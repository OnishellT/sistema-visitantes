                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div
                                            ...
                                            {!! Html::decode(Form::label('first_name', 'Nombre <span class="text-danger">*</span>', ['class' => 'control-label'])) !!}
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div
                                            ...
                                            {!! Html::decode(Form::label('last_name', 'Apellido <span class="text-danger">*</span>', ['class' => 'control-label'])) !!}
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group {{ $errors->has('email') ? 'has-error' : ''}}">
                                            ...
                                            {!! Form::email('email', isset($visitor->email) ? $visitor->email : null, ('' == 'required') ? ['class' => 'form-control input', 'id '=>'email'] : ['class' => 'form-control input','id '=>'email']) !!}
                                            {!! $errors->first('email', '<p class="text-danger">:message</p>') !!}
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group {{ $errors->has('phone') ? 'has-error' : ''}}">
                                            {!! Html::decode(Form::label('phone', 'Telefono <span class="text-danger">*</span>', ['class' => 'control-label'])) !!}
                                            {!! Form::text('phone', isset($visitor->phone) ? $visitor->phone : null, ('' == 'required') ? ['class' => 'form-control input', 'id '=>'phone'] : ['class' => 'form-control input','id '=>'phone']) !!}
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group {{ $errors->has('company_name') ? 'has-error' : ''}}">
                                            {!! Form::label('company_name', 'Compañia', ['class' => 'control-label']) !!}
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group {{ $errors->has('national_identification_no') ? 'has-error' : ''}}">
                                            {!! Form::label('national_identification_no', 'Documento de Identificacion', ['class' => 'control-label']) !!}
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group {{ $errors->has('purpose') ? 'has-error' : ''}}">
                                            <label for="purpose">{{ __('Motivo de la Visita') }}</label> <span class="text-danger">*</span>
