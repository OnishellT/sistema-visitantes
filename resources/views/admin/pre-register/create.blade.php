                        ...
                        <form action="{{ route('admin.pre-registers.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col">
                                        <label for="employee_id">{{ __('Select Employee') }}</label> <span class="text-danger">*</span>
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        <label>{{ __('Fecha de Espera') }}</label> <span class="text-danger">*</span>
                                    ...
                                    <div class="form-group col">
                                        <label for="expected_time">{{ __('Hora de Espera') }}</label> <span class="text-danger">*</span>
                            ...
                            <div class="card-footer ">
                                <button class="btn btn-primary mr-1" type="submit">{{ __('Guardar') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
