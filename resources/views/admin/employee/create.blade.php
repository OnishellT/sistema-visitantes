                    ...
                    <div class="card">
                        <form action="{{ route('admin.employees.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        <label>{{ __('E-Mail') }}</label> <span class="text-danger">*</span>
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        <label>{{ __('Fecha de Entrada') }}</label> <span class="text-danger">*</span>
                                        <input type="text" autocomplete="off" id="date-picker" name="date_of_joining" class="form-control @error('date_of_joining') is-invalid @enderror" value="{{ old('date_of_joining') }}">
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        <label for="department_id">{{ __('Departmento') }}</label> <span class="text-danger">*</span>
                                    ...
                                    <div class="form-group col">
                                        <label for="designation_id">{{ __('Designatcion') }}</label> <span class="text-danger">*</span>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col">
                                        <label>{{ __('Confirmar Contraseña') }}</label> <span class="text-danger">*</span>
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        <label for="about">{{ __('Acerca de') }}</label>
                                        <textarea name="about"
