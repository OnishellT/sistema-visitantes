        ...
        <div class="card-body">
            <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.setting.site-update') }}"
                ...
                <fieldset class="setting-fieldset">
                    <legend class="setting-legend">{{ __('Opciones Generales') }}</legend>
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label
                                    for="site_phone_number">{{ __('Numero Telefonico de Sitio Web') }}</label>
                                <span class="text-danger">*</span>
                            ...
                            <div class="form-group">
                                <label for="site_address">{{ __('Direccion del Sisito Web') }}</label> <span
                                    class="text-danger">*</span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="customFile">{{ __('Selecionar Archivo') }}</label>
                                </div>
                                @error('site_logo')
                                <div class="invalid-feedback">
                                    {{ $message }}
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        <button class="btn btn-primary">
                            <span>{{ __('Actualizar Opciones de Sitio Web') }}</span>
                        </button>
                    </div>
                </div>
            </form>
