            ...
            <div class="card-body">
                <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.setting.sms-update') }}">
                    ...
                    <fieldset class="setting-fieldset">
                        <legend class="setting-legend">{{ __('OPciones de SMS') }}</legend>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="twilio_auth_token">{{ __('Token de Twilio') }}</label> <span
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="twilio_disabled" id="twilio_disabled"
                                        ...
                                        <option value="1" {{ (old('twilio_disabled', setting('twilio_disabled')) == 1) ? 'selected' : '' }}> {{ __('Activo') }}</option>
                                        <option value="0" {{ (old('twilio_disabled', setting('twilio_disabled')) == 0) ? 'selected' : '' }}> {{ __('Inactivo') }}</option>
                                    </select>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <button class="btn btn-primary">
                                <span>{{ __('Actualizar Opciones de SMS') }}</span>
                            </button>
                        </div>
                    </div>
                </form>
