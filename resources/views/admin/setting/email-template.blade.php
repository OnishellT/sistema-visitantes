            ...
            <div class="card-body">
                <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.setting.email-template-update') }}">
                     ...
                     <fieldset class="setting-fieldset">
                        <legend class="setting-legend">{{ __('Opciones de Email y SMS ') }}</legend>
                         <div class="row">
                             <div class="col-md-12">
                                 <div class="form-group">
                                     <label for="comment">{{__('Plantilla de notificacion')}}</label>
                                     <textarea class="summernote" name="notify_templates" id="summernote">{{ setting('notify_templates') }}</textarea>
                                 </div>
                                 <div class="form-group">
                                     <label for="comment">{{__('Plantilla de Invitacion')}}</label>
