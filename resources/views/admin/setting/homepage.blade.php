            ...
            <div class="card-body">
                <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.setting.homepage-update') }}">
                     ...
                     <fieldset class="setting-fieldset">
                        <legend class="setting-legend">{{ __('Pagina Principal ') }}</legend>
                         <div class="row">
                             <div class="col-md-6">
                                 <div class="form-group" id="">
                                     <label class="control-label" for="defaultUnchecked">{{__('Pagina Principal  ')}}</label>
                             ...
                             <div class="col-md-6">
                                 <div class="form-group" id="">
                                     <label class="control-label" for="defaultUnchecked">{{__('Acuerdo del Visitante ')}}</label>
                                     <div class="form-check">
                                         <label class="form-check-label">
                    ...
                    <fieldset class="setting-fieldset">
                        <legend class="setting-legend">{{ __('Bienvenido') }}</legend>
                        <div class="row">
                            <div class="col-md-12">
                    ...
                    <fieldset class="setting-fieldset">
                        <legend class="setting-legend">{{ __('Opciones de Terminos y Condiciones') }}</legend>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                     ...
                     <div class="row">
                         <div class="form-group col-md-6">
                            <button type="submit" class="btn btn-primary">
                                <span>{{ __('Actualizar Opciones de la Pagina Principal') }}</span>
                            </button>
                         </div>
                     </div>
                </form>
